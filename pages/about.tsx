...
const About: NextPage = () => {
  ...
  return (
    <Layout title="Sam Clark | About">
      <div className="mx-auto max-w-md px-4 pt-24">
        <div className="relative mb-8">
          <motion.div
            initial={{ opacity: 0, x: 30 }}
            animate={
              imageLoaded ? { opacity: 0.2, x: 0 } : { opacity: 0, x: 30 }
            }
            transition={{
              delay: 0.2,
              duration: 1,
          ...
          <p className="mb-6 text-gray-600">
            ...
            technologies but primarily focused on Typescript, Next.js, React,
            Node and Cypress. I am always looking to expand my toolkit but also
            see value in spending time to learn and incorporate a piece of tech
            into my workflow before always jumping to the ‘next big thing’.
          </p>
          <p className="mb-6 text-gray-600">
